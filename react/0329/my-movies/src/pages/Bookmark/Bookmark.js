...
export default function BookmarkPage() {
  ...
  React.useEffect(() => dispatch(readAllBookmarkAction()), [dispatch])

  const handleRemoveBookmark = (willRemoveBookmark) => {
    dispatch(deleteBookmarkAction(willRemoveBookmark))
  }
              ...
              <Bookmark key={id}>
                ...
                <Bookmark.Container isMobile={isMobile}>
                  <Bookmark.Container column>
                    <Bookmark.Title isMobile={isMobile}>{title}</Bookmark.Title>
